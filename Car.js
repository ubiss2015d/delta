...
THREE.Car = function()
{
	...
	function control_car(is_user_control)
	{
		if (is_user_control === this.is_controlled)
			return;
		...
		this.is_controlled = is_user_control;
		if (!this.is_controlled)
		{
			this.calculate_current_position();
			this.follow_trip_detail();
		}
		
	}
	function calculate_current_position()
	{
		//TODO
	}
